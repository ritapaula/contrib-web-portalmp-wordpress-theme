<article @php(post_class())>
  ...
  <div class="entry-content page-content">
    <p class="description-title"><strong>Empresa:</strong> {{ get_post_meta(get_the_ID(), 'uvigo_offers_offer_company', true) }}</p>
    <p class="description-title"><strong>Lugar de traballo:</strong> {{ get_post_meta(get_the_ID(), 'uvigo_offers_offer_workplace', true) }}</p>
    ...
    @php(the_content())
    <p class="description-url">Consulta o detalle na <a href="{{ get_post_meta(get_the_ID(), 'uvigo_offers_offer_url', true) }}" target="_blank">área de emprego da UVigo</a></p>
  </div>
  <footer>
