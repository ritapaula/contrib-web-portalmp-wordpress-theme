<header class="banner">
  ...
  <div id="currentsearch" class="currentsearch">
    <div class="currentsearch__container">
        ...
        <button type="button" id="globalsearch__toggle-button" data-toggle="search" data-target="#currentsearch" class="btn globalsearch__toggle-button close-button" data-icon="&#x4d;"><span class="sr-only">{{ __( 'Close', 'uvigothemewp' ) }}</span></button>
