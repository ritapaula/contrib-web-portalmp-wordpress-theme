<article @php(post_class())>
  ...
  <div class="entry-content page-content">
    ...
    @php(the_content())
    <p class="description-url">Consulta o detalle na <a href="{{ get_post_meta(get_the_ID(), 'uvigo_offers_practice_url', true) }}" target="_blank">área de emprego da UVigo</a></p>
  </div>
  <footer>
